...
namespace Gmail10.Services.NavigationService
{
    public class NavigationService
    {
        ...
        string LastNavigationParameter { get; set; /* TODOAdaptiveUISample: persist */ }
        string LastNavigationType { get; set; /* TODOAdaptiveUISample: persist */ }
        ...
        async void NavigateTo(NavigationMode mode, string parameter)
        {
            ...
            {
                // TODOAdaptiveUISample: clear existing state
            }
        ...
        public void RestoreSavedNavigation() { /* TODOAdaptiveUISample */ }
        ...
        {
            for(int i=0;i < _frame.BackStackDepth;i++)
            {
                _frame.GoBack();
            }
        }
